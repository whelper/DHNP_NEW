<%@ Page Language="C#" MasterPageFile="/en/EnSiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_global_human_list.aspx.cs" Inherits="MobileWeb.en.pdt.pdt_global_human_list" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
	...
	<section class="container">
		<h1 class="acc-hidden">Pharmaceutical</h1>	
		<ul class="tap_2depth">
			<li> <a href="pdt_global_human_list.aspx" class="onhover">Pharmaceutical</a></li>
			<li> <a href="pdt_global_animal_list.aspx">Animal Health & Nutrition</a></li>
		</ul>
		<!--   content -->
             ...
             $.ajax({
                ...
                , success: function (xml, status) {
                    ...
                    $(xml).find("Result>List>Products").each(function () {
                        ...
                        html += '   </span>';
                        html += '   <a href="/en/pdt/pdt_global_human_view.aspx?prod_cd=' + PROD_CD + '" class="right_text">';
                        html += '		<h1>' + PROD_NM + '</h1>';
                        html += '		<p>' + USAGE + '</p>';
                        html += '	</a>';
                        html += '</article>';
