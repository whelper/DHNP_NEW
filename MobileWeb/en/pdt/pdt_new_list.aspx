...
<%@ Page Title="" Language="C#" MasterPageFile="/en/EnSiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_new_list.aspx.cs" Inherits="MobileWeb.en.pdt.pdt_new_list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
	<header class="header">
		...
		<p class="location">
			...
			<span><%=(menu.Substring(0, 2) == "01") ? "Pharmaceutical" : "Animal Health & Nutrition" %></span><em>></em>
	...
	<section class="container">
		<h1 class="acc-hidden">Products</h1>	
		<ul class="tap_3depth">
			<%if (menu.Substring(0, 2) == "01"){ %>
			<li style="width:50%"> <a href="pdt_new_list.aspx?category=09&menu=0102" class="onhover">New Products</a></li>
			<li style="width:50%"> <a href="pdt_list.aspx?category=09&menu=0103">Products</a></li>
			<%}else if(menu.Substring(0, 2) == "02"){ %>
			<li style="width:50%"> <a href="pdt_new_list.aspx?category=10&menu=0202" class="onhover">New Products</a></li>
			<li style="width:50%"> <a href="pdt_list.aspx?category=10&menu=0201">Products</a></li>
			<%}%>
		</ul>
		<!--   content -->
