<%@ Page Language="C#" MasterPageFile="/en/EnSiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_human_products_list.aspx.cs" Inherits="MobileWeb.en.pdt.pdt_human_products_list" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
	...
	<header class="header">
		...
		<p class="location">
			...
			<span>Pharmaceutical</span><em>></em>
	...
	<section class="container">
		...
		<ul class="tap_2depth">
			<li> <a href="pdt_human_new_list.aspx">New Products</a></li>
			<li> <a href="pdt_human_products_list.aspx" class="onhover">Products</a></li>
		</ul>
		<!--   content -->
     ...
     <script language="javascript">
         ...
         var search = function (init_code) {
             ...
             location.href = "pdt_human_products_list.aspx?prod_initial=" + init_code + "&catg_no2=" + catg_no2 + "&search_text=" + search_text;
         }
             ...
             $.ajax({
                ...
                , success: function (xml, status) {
                    ...
                    $(xml).find("Result>List>Products").each(function () {
                        ...
                        html += '   </span>';
                        html += '   <a href="/en/pdt/pdt_human_products_view.aspx?prod_cd=' + PROD_CD + '" class="right_text">';
                        html += '		<h1>' + PROD_NM + '</h1>';
                        html += '		<p>' + USAGE + '</p>';
                        html += '	</a>';
                        html += '</article>';
