<%@ Page Language="C#" MasterPageFile="/en/EnSiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_bio_badge_list.aspx.cs" Inherits="MobileWeb.en.pdt.pdt_bio_badge_list" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
	...
	<section class="container">
		<h1 class="acc-hidden">Cell Culture Media</h1>	
		<ul class="tap_3depth">
			<li> <a href="pdt_bio_badge_list.aspx" class="onhover">Cell Culture Media</a></li>
		...
		<section class="content">
			<div class="lineB">
				<fieldset class="search_products w600">
					...
					<span class="input_bg"><input type="text" id="search_text" name="search_text" runat="server" placeholder="요" /></span>
