...
{
	public partial class pdt_new_list : PageBase
	{
		private const string LANG_CD = "ENG";
		private const string CATG_NO1 = "2";
		private const string PROD_TYPE_CD = "PROD_NEW"; // 제품유형 코드 - 신제품
		...
		{
			Response.Redirect("pdt_human_products_list.aspx?prod_initial=" + ProdInitial + "&catg_no2=" + catg_no2.SelectedValue + "&search_text=" + search_text.Value);
		}
