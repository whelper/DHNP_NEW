<%@ Page Language="C#" MasterPageFile="/en/EnSiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_bio_resin_list.aspx.cs" Inherits="MobileWeb.en.pdt.pdt_bio_resin_list" %>

<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">

	<header class="header">
		<script src="<%=GetRoot() %>/en/common/include/header.js"></script> 	
		<h1 class="acc-hidden">Chromatography Resins</h1>	
		<p class="location">
			<span>Products</span><em>></em>
			<span>Bioprocess</span><em>></em>
			<strong>Chromatography Resins</strong>
		</p>
	</header>
	...
	<section class="container">
		<h1 class="acc-hidden">레진</h1>	
		<ul class="tap_3depth">
			<li> <a href="pdt_bio_badge_list.aspx">Cell Culture Media</a></li>
			<li> <a href="pdt_bio_resin_list.aspx" class="onhover">Chromatography Resins</a></li>
			<li> <a href="pdt_bio_catalog_list.aspx">Catalog Products</a></li>
		</ul>
		<!--   content -->
     ...
     <script language="javascript">
         ...
         var search = function (init_code) {
             ...
             location.href = "./pdt_bio_resin_list.aspx?prod_initial=" + init_code + "&search_text=" + search_text;
         }
             ...
             $.ajax({
                ...
                , success: function (xml, status) {
                    ...
                    $(xml).find("Result>List>Products").each(function () {
                        ...
                        html += '   </span>';
                        html += '   <a href="/en/pdt/pdt_bio_resin_view.aspx?prod_cd=' + PROD_CD + '" class="right_text">';
                        html += '		<h1>' + PROD_NM + '</h1>';
                        html += '		<p>' + USAGE + '</p>';
                        html += '	</a>';
                        html += '</article>';
