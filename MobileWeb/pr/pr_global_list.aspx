<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="pr_global_list.aspx.cs" Inherits="MobileWeb.pr.pr_global_list" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
	...
	<section class="container">
		<h1 class="acc-hidden">해외자원개발</h1>
		<div class="title_img"> 
			<img src="<%=GetRoot() %>/common/images/pr_title_global.png" alt="global" width="100%" >
		</div>
		...
		<section class="content pB40">
			<h1 class="acc-hidden">해외자원투자 리스트</h1>
			<div class="list_box">
    ...
    <script language="javascript">
        ...
        function more_list() {
            ...
            $.ajax({
                type: "POST"
                , cache: false
                , url: "<%=GetRoot() %>/ws/promotion.asmx/GetGlobalList"
                , data: {
                    "now_page": now_page
                ...
                , success: function (xml, status) {
                    ...
                    $(xml).find("Promotion").each(function () {
                        ...
                        html += '<li>';
                        html += '	<a href="pr_global_view.aspx?seq_no=' + SEQ_NO + '">' + TTL + '</a>';
                        html += '</li>';
                    });
