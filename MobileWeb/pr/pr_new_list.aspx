<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="pr_new_list.aspx.cs" Inherits="MobileWeb.pr.pr_new_list" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
	...
	<section class="container">
		<h1 class="acc-hidden">새소식</h1>
		<div class="title_img"> 
			<img src="<%=GetRoot() %>/common/images/pr_title_news.png" alt="news" width="100%" />
		</div>
		...
		<section class="content pB40">
			<h1 class="acc-hidden">새소식 리스트</h1>
			<div class="list_box">
    ...
    <script language="javascript">
        ...
        function more_list() {
            ...
            $.ajax({
                type: "POST"
                , cache: false
                , url: "<%=GetRoot() %>/ws/promotion.asmx/GetNewList"
                , data: {
                    "now_page": now_page
                ...
                , success: function (xml, status) {
                    ...
                    $(xml).find("Promotion").each(function () {
                        ...
                        html += '<li>';
                        html += '	<a href="pr_new_view.aspx?seq_no=' + SEQ_NO + '">' + TTL + '</a>';
                        html += '</li>';
                    });
