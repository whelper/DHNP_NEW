<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_human_new_list.aspx.cs" Inherits="MobileWeb.pdt.pdt_human_new_list" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
	...
	<section class="container">
		...
		<ul class="tap_2depth">
			<li> <a href="pdt_human_new_list.aspx" class="onhover">신제품</a></li>
			<li> <a href="pdt_human_products_list.aspx">제품소개</a></li>
		</ul>
		<!--   content -->
             ...
             $.ajax({
                ...
                , success: function (xml, status) {
                    ...
                    $(xml).find("Result>List>Products").each(function () {
                        ...
                        html += '   </span>';
                        html += '   <a href="/pdt/pdt_human_new_view.aspx?prod_cd=' + PROD_CD + '" class="right_text">';
                        html += '		<h1>' + PROD_NM + '</h1>';
                        html += '		<p>' + USAGE + '</p>';
                        html += '	</a>';
                        html += '</article>';
