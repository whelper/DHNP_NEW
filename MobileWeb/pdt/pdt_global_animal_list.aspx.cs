...
{
    public partial class pdt_global_animal_list : PageBase
    {
        ...
        {
            Response.Redirect("pdt_global_animal_list.aspx?prod_initial=" + ProdInitial + "&catg_no2=" + catg_no2.SelectedValue + "&search_text=" + search_text.Value);
        }
