<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_global_animal_list.aspx.cs" Inherits="MobileWeb.pdt.pdt_global_animal_list" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">

	<header class="header">
		<script src="<%=GetRoot() %>/common/include/header.js"></script> 	
		<h1 class="acc-hidden">수출의약품</h1>	
		<p class="location">
			<span>제품</span><em>></em>
			<span>수출의약품</span><em>></em>
			<strong>동물 의약품</strong>
		</p>
	</header>
	...
	<section class="container">
		...
		<ul class="tap_2depth">
			<li> <a href="pdt_global_human_list.aspx">인체 의약품</a></li>
			<li> <a href="pdt_global_animal_list.aspx" class="onhover">동물 의약품</a></li>
		</ul>
		<!--   content -->
             ...
             $.ajax({
                ...
                , success: function (xml, status) {
                    ...
                    $(xml).find("Result>List>Products").each(function () {
                        ...
                        html += '   </span>';
                        html += '   <a href="/pdt/pdt_global_animal_view.aspx?prod_cd=' + PROD_CD + '" class="right_text">';
                        html += '		<h1>' + PROD_NM + '</h1>';
                        html += '		<p>' + USAGE + '</p>';
                        html += '	</a>';
                        html += '</article>';
