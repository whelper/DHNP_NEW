<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_animal_delivery_list.aspx.cs" Inherits="MobileWeb.pdt.pdt_animal_delivery_list" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
	...
	<section class="container">
		<h1 class="acc-hidden">관납제품</h1>	
		<ul class="tap_3depth">
			<li> <a href="pdt_animal_new_list.aspx">신제품</a></li>
			<li> <a href="pdt_animal_products_list.aspx">제품소개</a></li>
			<li> <a href="pdt_animal_delivery_list.aspx" class="onhover">관납제품</a></li>
		</ul>
		<!--   content -->
     ...
     <script language="javascript">
         ...
         var search = function (init_code) {
             ...
             location.href = "./pdt_animal_delivery_list.aspx?prod_initial=" + init_code + "&catg_no2=" + catg_no2 + "&search_text=" + search_text;
         }
             ...
             $.ajax({
                ...
                , success: function (xml, status) {
                    ...
                    $(xml).find("Result>List>Products").each(function () {
                        ...
                        html += '   </span>';
                        html += '   <a href="/pdt/pdt_animal_delivery_view.aspx?prod_cd=' + PROD_CD + '" class="right_text">';
                        html += '		<h1>' + PROD_NM + '</h1>';
                        html += '		<p>' + USAGE + '</p>';
                        html += '	</a>';
                        html += '</article>';
