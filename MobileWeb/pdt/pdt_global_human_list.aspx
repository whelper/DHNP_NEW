<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_global_human_list.aspx.cs" Inherits="MobileWeb.pdt.pdt_global_human_list" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
	...
	<section class="container">
		...
		<ul class="tap_2depth">
			<li> <a href="pdt_global_human_list.aspx" class="onhover">인체 의약품</a></li>
			<li> <a href="pdt_global_animal_list.aspx">동물 의약품</a></li>
		</ul>
		<!--   content -->
     ...
     <script language="javascript">
         ...
         var search = function (init_code) {
             ...
             location.href = "./pdt_global_human_list.aspx?prod_initial=" + init_code + "&catg_no2=" + catg_no2 + "&search_text=" + search_text;
         }
             ...
             $.ajax({
                ...
                , success: function (xml, status) {
                    ...
                    $(xml).find("Result>List>Products").each(function () {
                        ...
                        html += '   </span>';
                        html += '   <a href="/pdt/pdt_global_human_view.aspx?prod_cd=' + PROD_CD + '" class="right_text">';
                        html += '		<h1>' + PROD_NM + '</h1>';
                        html += '		<p>' + USAGE + '</p>';
                        html += '	</a>';
                        html += '</article>';
