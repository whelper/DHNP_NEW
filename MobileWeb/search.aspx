<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="search.aspx.cs" EnableEventValidation="false" Inherits="MobileWeb.search" %>
    ...
    <script src="<%=GetRoot() %>/common/include/footer.js" ></script>
     ...
     <script language="javascript">
         ...
         var search = function () {
             ...
             location.href = "./search.aspx?search_text=" + search_text;
         }
