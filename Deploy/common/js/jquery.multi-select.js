...
/* 한글 encode,decode 처리 수정 적용 - add by chaney 0821 */
/* 코드이슈 처리 : optgroup label 한글 적용 시 출력오류 */
  ...
  MultiSelect.prototype = {
    ...
    'generateLisFromOption' : function(option){
      ...
      if ($optgroup.length > 0){
        var optgroupLabel = encodeURIComponent($optgroup.attr('label')),  // add by chaney - 0821
        //var optgroupLabel = $optgroup.attr('label'),
            optgroupId = that.sanitize(optgroupLabel, that.sanitizeRegexp),
            $selectableOptgroup = that.$selectableUl.find('#optgroup-selectable-'+optgroupId),
            $selectionOptgroup = that.$selectionUl.find('#optgroup-selection-'+optgroupId);
        
            console.log(decodeURI(optgroupLabel,"UTF-8")); // add by chaney - 0821

        if ($selectableOptgroup.length === 0){
          var optgroupContainerTpl = '<li class="ms-optgroup-container"></li>',
              //optgroupTpl = '<ul class="ms-optgroup"><li class="ms-optgroup-label"><span>'+optgroupLabel+'</span></li></ul>';
              optgroupTpl = '<ul class="ms-optgroup"><li class="ms-optgroup-label"><span>'+decodeURI(optgroupLabel,"UTF-8")+'</span></li></ul>';  // add by chaney - 0821
