<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="money_mark_list_eng.aspx.cs" Inherits="AdminSite.inv.money_mark_list_eng" %>
	...
	<div class="wrap_box clear">
        ...
        * 영문 덮어쓰기는 국문탭에만 있는 기능으로 국문에 입력한 내용을 영문에 그대로 적용 시킵니다.
		<ul class="list_tab  clearfix target">
			<li><a href="money_mark_list.aspx"> 국문 </a></li>
			<li class="tab_on"><a href="money_mark_list_eng.aspx"> 영문 </a></li>
		</ul>
		<!-- 1. 유동자산   -->
		<table cellpadding="0" cellspacing="0" border="0" id= "tbl_current_assets" class="table_frm td_center">
			<colgroup>
	            ...
	            <tbody>
					...
					<td><input type="text" name= "ca_data2" value="<%=GetData(0, 2, "FIRST_COL") %>"></td>
					<td><input type="text" name= "ca_data3" value="<%=GetData(0, 2, "FIRST_COL") %>"></td>
	                </tr>
                    <%  
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table_frm td_center mB50">
			...
			<tbody>
				<tr> 
					...
					<td><input type="text" name= "ca_data5" value="<%=GetData(0, 3, "FIRST_COL") %>"></td>                                                                   
					<td><input type="text" name= "ca_data6" value="<%=GetData(0, 3, "FIRST_COL") %>"></td>                                                                                                              
				</tr>
			</tbody>
		</table>
		<!-- //  1. 유동자산   -->	
			...
			<colgroup>
	            ...
	            <tbody>
	                <tr>
					    ...
					    <td><input type="text" name= "nca_data2" value="<%=GetData(0, 4, "FIRST_COL") %>"></td>
					    <td><input type="text" name= "nca_data3" value="<%=GetData(0, 4, "FIRST_COL") %>"></td>
	                </tr>
                     </tr>
                    <%  
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table_frm mB50">
			...
			<tbody>
				<tr> 
					...
					<td><input type="text" name= "nca_data5" value="<%=GetData(0, 5, "FIRST_COL") %>"></td>                                                                   
					<td><input type="text" name= "nca_data6" value="<%=GetData(0, 5, "FIRST_COL") %>"></td>                                                                                                              
				</tr>
				<tr> 
					<th><strong>  자산 계 </strong>  </th>                                                                                                                   
					<td><input type="text" name= "ca_t_data1" value="<%=GetData(0, 6, "FIRST_COL") %>"></td>  
					<td><input type="text" name= "ca_t_data2" value="<%=GetData(0, 6, "FIRST_COL") %>"></td>                                                                   
					<td><input type="text" name= "ca_t_data3" value="<%=GetData(0, 6, "FIRST_COL") %>"></td>                                                                                                              
				</tr>
			</tbody>
		</table>
		<!-- //  2. 비유동자산   -->
		...
		<table cellpadding="0" cellspacing="0" border="0" id= "tbl_current_debt" class="table_frm ">
			<colgroup>
	            ...
	            <tbody>
					...
					<td><input type="text" name= "cd_data2" value="<%=GetData(0, 7, "FIRST_COL") %>"></td>
					<td><input type="text" name= "cd_data3" value="<%=GetData(0, 7, "FIRST_COL") %>"></td>
	                </tr>
                     </tr>
                    <%  
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table_frm mB50">
			...
			<tbody>
				<tr> 
					...
					<td><input type="text" name= "cd_data5" value="<%=GetData(0, 8, "FIRST_COL") %>"></td>                                                                   
					<td><input type="text" name= "cd_data6" value="<%=GetData(0, 8, "FIRST_COL") %>"></td>                                                                                                              
				</tr>
			</tbody>
		</table>
		<!-- // 3. 유동부채    -->
		...
		<table cellpadding="0" cellspacing="0" border="0" id= "tbl_n_current_debt" class="table_frm">
			<colgroup>
	            ...
	            <tbody>
					...
					<td><input type="text" name= "ncd_data2" value="<%=GetData(0, 9, "FIRST_COL") %>"></td>
					<td><input type="text" name= "ncd_data3" value="<%=GetData(0, 9, "FIRST_COL") %>"></td>
	                </tr>
                     </tr>
                    <%  
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table_frm mB50">
			...
			<tbody>
				<tr> 
					...
					<td><input type="text" name= "ncd_data5" value="<%=GetData(0, 10, "FIRST_COL") %>"></td>                                                                   
					<td><input type="text" name= "ncd_data6" value="<%=GetData(0, 10, "FIRST_COL") %>"></td>                                                                                                              
				</tr>
				<tr> 
					<th><strong>  부채 계 </strong>  </th>                                                                                                                   
					<td><input type="text" name= "cd_t_data1" value="<%=GetData(0, 11, "FIRST_COL") %>"></td>  
					<td><input type="text" name= "cd_t_data2" value="<%=GetData(0, 11, "FIRST_COL") %>"></td>                                                                   
					<td><input type="text" name= "cd_t_data3" value="<%=GetData(0, 11, "FIRST_COL") %>"></td>                                                                                                              
				</tr>
			</tbody>
		</table>
		<!-- // 4. 비유동부채    -->
		...
		<table cellpadding="0" cellspacing="0" border="0" id="tbl_capital" class="table_frm">
			<colgroup>
	            ...
	            <tbody>
					...
					<td><input type="text" name="cp_data2" value="<%=GetData(0, 12, "FIRST_COL") %>"></td>
					<td><input type="text" name="cp_data3" value="<%=GetData(0, 12, "FIRST_COL") %>"></td>
	                </tr>
                     </tr>
                    <%  
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table_frm mB50">
			...
			<tbody>
				<tr> 
					...
					<td><input type="text" name="cp_data5" value="<%=GetData(0, 13, "FIRST_COL") %>"></td>                                                                   
					<td><input type="text" name="cp_data6" value="<%=GetData(0, 13, "FIRST_COL") %>"></td>                                                                                                              
				</tr>
				<tr> 
					<th><strong>  부채 / 자본 계 </strong>  </th>                                                                                                                   
					<td><input type="text" name="cad_t_data1" value="<%=GetData(0, 14, "FIRST_COL") %>"></td>  
					<td><input type="text" name="cad_t_data2" value="<%=GetData(0, 14, "FIRST_COL") %>"></td>                                                                   
					<td><input type="text" name="cad_t_data3" value="<%=GetData(0, 14, "FIRST_COL") %>"></td>                                                                                                              
				</tr>
			</tbody>
		</table>
		<!-- // 5. 자본   -->
