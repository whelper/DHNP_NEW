<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_ex_human_list.aspx.cs" Inherits="AdminSite.pdt.pdt_ex_human_list" %>
...
<div id="content">
	...
	<div class="wrap_box">
        <ul class="list_tab  clearfix target" >
		    <li class="tab_on"><a href="pdt_ex_human_list.aspx">수출 의약품(인체)</a></li>
            <li><a href="pdt_catalog_list.aspx?upr_catg_no=4">대표카탈로그</a></li>
	    </ul>
        <!--
			...
			<tbody>
				...
				<tr> 
					...
					<td>        
						...
						<label for="pdt_human"><input type="radio" runat="server" id="prod_body_drug" name="pdt_style" class="inline" value="PROD_BODY_DRUG" />인체 의약품</label>&nbsp;
						<label for="pdt_ani"><input type="radio" runat="server" id="prod_ani_drug" name="pdt_style" class="inline" value="PROD_ANI_DRUG" />동물 의약품</label>&nbsp;
					</td> 
				</tr> 
			</tbody>
		</table>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table_new">
            ...
            %>
				<tr>
					...
					<td class="alignleft" ><a href="pdt_ex_human_detail.aspx?prod_cd=<%=GetData(i, "PROD_CD")%>"><%=GetData(i, "PROD_NM")%></a> </td>
		...
		<div class="btn_area clearfix">
			<div class="f_right">
				<a href="./pdt_ex_human_detail.aspx"><span class="btn btn-ok">등록</span></a>
			</div>
		</div>
