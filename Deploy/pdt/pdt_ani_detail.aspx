<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="pdt_ani_detail.aspx.cs" Inherits="AdminSite.pdt.pdt_ani_detail" %>
...
<div id="content">
	...
	<div class="wrap_box">
        <ul class="list_tab  clearfix target" >
			<li<%if ("KOR".Equals(LANG_CD)) { %> class="tab_on"<%} %>><a href="pdt_ani_detail.aspx?prod_cd=<%=ProdCd %>&LANG_CD=KOR">국문</a></li>
			<li<%if ("ENG".Equals(LANG_CD)) { %> class="tab_on"<%} %>><a href="pdt_ani_detail.aspx?prod_cd=<%=ProdCd %>&LANG_CD=ENG">영문</a></li>
		</ul>
		<table cellpadding="0" cellspacing="0" border="0" class="table_frm">
			...
			<tbody>
				...
				<tr>
					<th scope="row"> 
						<label for="pdt_section">분류번호</label>   
					</th>
					<td class="alignleft" colspan="2">     
				...
				<tr>
					<th scope="row" > 
						<label for="pdt_component">주요성분</label>   
					</th>
                ...
                <tr>
					<th scope="row"> <label for="pdt_boheom">보험코드</label></th>
					<td class="alignleft" colspan="2">     
