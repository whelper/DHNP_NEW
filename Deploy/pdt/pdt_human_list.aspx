<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_human_list.aspx.cs" Inherits="AdminSite.pdt.pdt_human_list" %>
...
<div id="content">
	...
	<div class="wrap_box">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table_new">
            ...
            %>
				<tr>
					...
					<td class="alignleft" ><a href="pdt_human_detail.aspx?prod_cd=<%=GetData(i, "PROD_CD")%>"><%=GetData(i, "PROD_NM")%></a> </td>
        ...
        <div class="btn_area clearfix">
			<div class="f_right">
				<a href="./pdt_human_detail.aspx"><span class="btn btn-ok">등록</span></a>
			</div>
		</div>
