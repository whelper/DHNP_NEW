<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="job_notify_detail.aspx.cs" Inherits="AdminSite.rcm.job_notify_detail" %>
				...
				<colgroup>
					...
					<tbody>
						<tr>
							...
							<td class="alignleft" colspan="2">     
							 	<input type="text" id="writerNm" class="span6 text mR10" runat="server">      
								<label for="showTp1" class="mR10"><input type="radio" id="showTp1" name="pdt_style" class="inline" runat="server">상시</label>  &nbsp;
								<label for="showTp2" class="mR10"><input type="radio" id="showTp2" name="pdt_style" class="inline" runat="server">공지</label>  &nbsp;
								<label for="showTp3" class="mR10"><input type="radio" id="showTp3" name="pdt_style" class="inline" runat="server">정규</label>  &nbsp;
								<label for="showTp4"><input type="radio" id="showTp4" name="pdt_style" class="inline" runat="server">수시</label>  &nbsp;
							</td>
						</tr>
						<tr>
							<th scope="row"> 
					...
					<tr>
						...
						<td class="alignleft">
                            ...
                            %>
							<span class="side_span">* 현재 파일 : <a href="<%=GetData(0, "IMG1") %>" title="<%=GetData(0, "IMG1") %>"><%=GetFileName(GetData(0, "IMG1"), 70) %></a></span>
						</td>
					</tr>
					<tr>
						...
						<td class="alignleft">
                            ...
                            %>
							<span class="side_span">* 현재 파일 : <a href="<%=GetData(0, "IMG2") %>" title="<%=GetData(0, "IMG2") %>"><%=GetFileName(GetData(0, "IMG2"), 70) %></a></span>
						</td>
					</tr>
					<tr>
						...
						<td class="alignleft">
                            ...
                            %>
							<span class="side_span">* 현재 파일 : <a href="<%=GetData(0, "IMG3") %>" title="<%=GetData(0, "IMG3") %>"><%=GetFileName(GetData(0, "IMG3"), 70) %></a></span>
						</td>
					</tr>
					<tr>
						...
						<td class="alignleft">
                            ...
                            %>
							 <span class="side_span">* 현재 파일 : <a href="<%=GetData(0, "IMG4") %>" title="<%=GetData(0, "IMG4") %>"><%=GetFileName(GetData(0, "IMG4"), 70) %></a></span>
						</td>
					</tr>
					<tr>
						<th><label for="realupload_05"> 첨부파일 5 </label></th>
						<td class="alignleft">
							<div class="upload">
							    <div class="fakeupload">
                            ...
                            %>
							<span class="side_span">* 현재 파일 : <a href="<%=GetData(0, "IMG5") %>" title="<%=GetData(0, "IMG5") %>"><%=GetFileName(GetData(0, "IMG5"), 70) %></a></span>
						</td>
					</tr>
				</tbody>
			</table>
