<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="global_list.aspx.cs" Inherits="AdminSite.pr.global_list" %>
...
<div id="content">
	...
	<div class="wrap_box">
			...
			<tr>
                ...
                <td class="alignleft" >
                    <% if (GetData(i, "NEW_YN") == "Y") {%>
                        <i class="new"> NEW </i>
                    <%} %>
                        <a href="global_detail.aspx?seq_no=<%=GetData(i, "SEQ_NO")
                    %>"><%=GetData(i, "TTL", 100)%>
                        </a>
                </td>
		...
		<div class="btn_area clearfix">
			<div class="f_right">
				<a href="global_head.aspx"><span class="btn btn-ok">머릿말 등록</span></a>
				<a href="global_detail.aspx"><span class="btn btn-ok">등록</span></a>
			</div>
		</div>		
