<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="news_list.aspx.cs" Inherits="HomePage.pr.news_list" %>
...
<section id="content" class="sub_content" >
    ...
    <% 
        ...
        {
    %>
    <img src="/common/images/sub/new_title.png" class="mB10" alt="news" >
    <% 
        }
    %>
	...
	<table class="table_list" border="1">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="news_view.aspx?seq_no=<%=GetData(i, "SEQ_NO")%>&dp_seq_no=<%=GetBoardNum(i, Convert.ToInt32(nowPageNo.Value), 10)%>"><% if (GetData(i, "NEW_YN") == "Y") {%><i class="new"> NEW </i><%} %><%=GetData(i, "TTL")%></a></td>
