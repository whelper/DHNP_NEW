<%@ Page Language="C#" MasterPageFile="~/Products_Sub.Master" AutoEventWireup="true" CodeBehind="bio_badge_view.aspx.cs" Inherits="HomePage.products.bio_badge_view" %>
...
<section id="content" class="sub_content" >
	<header>
		...
		<p class="location">
			...
			<a href="/products/bio_badge_list.aspx"><strong>무혈청배지</strong></a>
		</p>
	</header>
	<!--  내용  ***************** -->
