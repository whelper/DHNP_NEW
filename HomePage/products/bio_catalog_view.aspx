<%@ Page Language="C#" MasterPageFile="~/Products_Sub.Master" AutoEventWireup="true" CodeBehind="bio_catalog_view.aspx.cs" Inherits="HomePage.products.bio_catalog_view" %>
...
<section id="content" class="sub_content" >
	<header>
		...
		<p class="location">
			...
			<a href="/products/bio_catalog_list.aspx"><strong>카달로그</strong></a>
		</p>
	</header>
	<!--  내용  ***************** -->
