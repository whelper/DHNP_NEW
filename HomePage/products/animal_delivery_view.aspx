<%@ Page Language="C#" MasterPageFile="~/Products_Sub.Master" AutoEventWireup="true" CodeBehind="animal_delivery_view.aspx.cs" Inherits="HomePage.products.animal_delivery_view" %>
...
<div id="pop_mov_guide" class="modal hide fade" style="display: none; ">
	...
	<div class="modal-body">	
		<div class="movie_iframe">
            <iframe width="100%" height="100%" style="height:300px" src="http://www.youtube.com/embed/<%=GetData(0, "CLIP_URL")%>" frameborder="0" allowscriptaccess="always" allowfullscreen="true"></iframe>
        </div>
	</div>
