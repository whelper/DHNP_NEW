<%@ Page Language="C#" MasterPageFile="~/Products_Sub.Master" AutoEventWireup="true" CodeBehind="animal_products_list.aspx.cs" Inherits="HomePage.products.animal_products_list" %>
...
<section id="content" class="sub_content" >
	<header>
		...
		<p class="location">
			...
			<a href="/products/animal_products_list.aspx"><strong>제품소개</strong></a>
		</p>
	</header>
	<!--  내용  ***************** -->
	...
	<section class="new_list clear">
		...
		<article class="list_Item about">
			<a href="/products/animal_products_view.aspx?prod_cd=<%=GetData(i, "PROD_CD") %>">
			    <% 
