<%@ Page Language="C#" MasterPageFile="~/Products_Sub.Master" AutoEventWireup="true" CodeBehind="bio_resin_list.aspx.cs" Inherits="HomePage.products.bio_resin_list" %>
...
<section id="content" class="sub_content" >
	<header>
		...
		<p class="location">
			...
			<a href="/products/bio_resin_list.aspx"><strong>레진</strong></a>
		</p>
	</header>
	<!--  내용  ***************** -->
	<img src="/common/images/products/bio_resin_ex.gif" alt="레진 TEXT" >
	<section class="new_list clear">
		...
		<article class="list_Item about">
			<a href="/products/bio_resin_view.aspx?prod_cd=<%=GetData(i, "PROD_CD") %>">
            <% 
