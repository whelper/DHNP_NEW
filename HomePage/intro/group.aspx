<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="group.aspx.cs" Inherits="HomePage.intro.group" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceSubLayer" runat="server">

<section id="content" class="sub_content" >
	<header>
		<h1 class="pageTitle line">조직도</h1>
		<p class="location">
			...
			<a href="/intro/group.aspx"><strong> 조직도</strong></a>
		</p>
	</header>
	<!--  내용  ***************** -->
	<img src="/common/images/sub/group.png" alt="">
