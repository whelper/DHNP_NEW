<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="ir_info_list.aspx.cs" Inherits="HomePage.invest.ir_info_list" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceSubLayer" runat="server">

<section id="content" class="sub_content" >
	<header>
		<h1 class="pageTitle">IR자료</h1>
		<p class="location">
			...
			<a href="/invest/ir_info_list.aspx"><span>경영정보</span></a><em> > </em>
			<a href="/invest/ir_info_list.aspx"><strong>IR자료</strong></a>
		</p>
	</header>
	<!--  내용  ***************** -->
	<table class="table_list" border="1" >
        ...
        %>
			<tr>
				...
				<td>
                    <a href="ir_info_view.aspx?seq_no=<%=GetData(i, "SEQ_NO")%>&dp_seq_no=<%=GetBoardNum(i, Convert.ToInt32(nowPageNo.Value), 10)%>"><%=GetData(i, "TTL")%></a>
                </td>
