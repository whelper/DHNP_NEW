...
{
    public partial class job_notify_list : PageBase
    {
        ...
        private void SearchData()
        {
            ...
            // 데이터 카운트 조회
            SetDataCount(1421, param.ToString());

            if (DataTotalCount > 0)
            {
                // 실 데이터 조회
                SetDataTableList(1422, param.ToString());
            }

            dsHeader = GetDataSet(1424, param.ToString());
        }
