...
{
    public partial class EnSiteSub : System.Web.UI.MasterPage
    {
        #region 변수 선언
        private string LANG_CD = "ENG";
        ...
        private static string[] prod_8 = { "bio_resin_list.aspx", "bio_resin_view.aspx" };                      // 바이오공정소재 - 레진
        ...
        private static string[] prod_12 = { "health_products_list.aspx" };                                 // 건강기능식품 - 제품소개
        private static string[] prod_13 = { "medical_list.aspx" };
        ...
        private static string[] prod_group_3 = { "bio_badge_list.aspx", "bio_badge_view.aspx", "bio_resin_list.aspx", "bio_resin_view.aspx" 
                                            , "bio_catalog_list.aspx", "bio_catalog_view.aspx"
                                        };
        private static string[] prod_group_4 = { "global_human_list.aspx", "global_human_view.aspx", "global_animal_list.aspx", "global_animal_view.aspx" };
        ...
        private static string[] recruit_group_1 = { "new_person.aspx", "new_evaluation.aspx" 
        ...
        {
            int result = 0;
            string[] uri = { "intro", "products", "pr", "invest", "recruit", "customer" };
