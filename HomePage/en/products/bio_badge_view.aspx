<%@ Page Language="C#" MasterPageFile="/en/EnProducts_Sub.Master" AutoEventWireup="true" CodeBehind="bio_badge_view.aspx.cs" Inherits="HomePage.en.products.bio_badge_view" %>
...
<section id="content" class="sub_content" >
	<header>
		<h1 class="pageTitle">Cell Culture Media</h1>
		<p class="location">
