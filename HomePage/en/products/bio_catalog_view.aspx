<%@ Page Language="C#" MasterPageFile="/en/EnProducts_Sub.Master" AutoEventWireup="true" CodeBehind="bio_catalog_view.aspx.cs" Inherits="HomePage.en.products.bio_catalog_view" %>
...
<section id="content" class="sub_content" >
	<header>
		<h1 class="pageTitle">Catalog Products</h1>
		<p class="location">
			...
			<a href="/en/products/bio_catalog_list.aspx"><strong>Catalog Products</strong></a>
		</p>
	</header>
	<!--  내용  ***************** -->
		...
		<!-- 갤러리 -->
	 	...
	 	<article class="view_text">
		  	...
		  	<ul class="view_text_ul">
	  			...
	  			<li><strong>보관</strong><em><%=GetData(0, "KEEP")%></em></li>
	  			<li><strong>규격</strong><em><%=GetData(0, "STAND")%></em></li>
	  		</ul>
	  		<p class="btn_target"> 
                <% 
	...
	<div class="con_tap_box">
	 	...
	 	<div class="sns_box"> 
  			<ul>
  				<li><div class="fb-share-button" data-href="http://dev001.mediagram.co.kr:8001/products/bio_catalog_view.aspx?prod_cd=<%=GetData(0, "PROD_CD") %>" data-type="button_count"></div></li>
  				<li><a href="https://twitter.com/share" class="twitter-share-button" data-url="http://dev001.mediagram.co.kr:8001/products/bio_catalog_view.aspx?prod_cd=<%=GetData(0, "PROD_CD") %>">Tweet</a></li>
