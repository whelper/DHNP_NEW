<%@ Page Language="C#" MasterPageFile="/en/EnProducts_Sub.Master" AutoEventWireup="true" CodeBehind="bio_catalog_list.aspx.cs" Inherits="HomePage.en.products.bio_catalog_list" %>
...
<section id="content" class="sub_content" >
	<header>
		<h1 class="pageTitle line">Catalog Products</h1>
		<p class="location">
    ...
    <!--  내용  ***************** -->
			<section class="new_list clear">
				<img src="/en/common/images/products/bio_catalog_ex.gif" alt="" >
				...
				<table class="table_list lineheight" border="1">
                    ...
                    %>
						<tr>
							<td scope="row"><img src="<%=GetData(i, "THUMBNAIL")%>" alt="" onerror='this.src=/en/common/images/products/no_big.jpg"' style="width:115px;height:104px;" /> </td>
							<td>&nbsp;</td>
							<td><%=GetData(i, "INTRO")%>
							</td>
							<td>&nbsp;</td>
                            ...
                            <% 
                                ...
                                {
                            %>
                                <a href="<%=GetData(i, "CATALOG") %>" class="button job_on" target="_blank">Download</a>
                            <% 
                                }
                            %>
                            </td>
