<%@ Page Language="C#" MasterPageFile="/en/EnProducts_Sub.Master" AutoEventWireup="true" CodeBehind="product_view.20170915.aspx.cs" Inherits="HomePage.en.products.product_view20170915" %>
...
<section id="content" class="sub_content" >
	...
	<div class="con_tap_box">
	 	...
	 	<div class="sns_box"> 
  			<ul>
  				<li><button type="button" onclick="javascript:history.back();" class="btn_view_list" ><span>list</span></button></li>
  			</ul>
  		</div>
	</div> <!--// con_tap_box -->
	<!-- // 내용 ***************** -->         
