<%@ Page Language="C#" MasterPageFile="/en/EnSite.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="search.aspx.cs" Inherits="HomePage.en.main.search" %>
...
<section  id="content" class="container" style="padding-bottom:50px;">
	<header>
		<h1><img src="/en/common/images/sub/search_title_01.gif" alt="통합검색"></h1>
		<p class="location" >
			<span><img src="/en/common/images/common/i_home.png" alt="home"></span>
			<strong style="line-height:16px;"> Search </strong>
		</p>
	</header>
	<img src="/en/common/images/sub/search_img.jpg" alt="대한뉴팜에서 출시되는 모든 의약품 및 제품을 검색하실수 있습니다. ">    
	...
	<div class="list_group clear">
        ...
        %>
		        <article class="list_Item total" >
			        <i class="<%=product_type%>"><%--<em>동물 의약품</em>--%></i>
			        <a href="<%="/en/products/product_view.aspx"  + "?category="+GetData(i, "CATE_CD")+"&PROD_CD=" + GetData(i, "PROD_CD")%>"><img src="<%=GetData(i, "PROD_IMG1") %>" width="232" height="177" alt="" onerror="this.src='/common/images/products/new_no.jpg'" /></a>
