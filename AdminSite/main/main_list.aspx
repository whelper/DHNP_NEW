<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="main_list.aspx.cs" Inherits="AdminSite.main.main_list" %>
					...
					<tr>
						...
						<td class="alignleft">
							<div  class="row_1 mB10">
								<span class="side_span">파일경로</span>
								<div class="upload">
									<label for="visual_text_02" class="blind" > 파일경로 </label>
									<div class="fakeupload inline" >
				...
				<tbody>
					<tr>
						...
						<td class="alignleft">
                            ...
                            <div  class="row_1" >
								<label for="main_pop_link_url" class="side_span"> 링크URL  </label>
								<div class="link_main">
