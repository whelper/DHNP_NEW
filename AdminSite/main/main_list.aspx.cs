...
{
    public partial class main_list : PageBase
    {
        ...
        private void InitControls()
        {
            ...
            visual_url_03.Value = GetData(0, 3, "LINK_URL");
            visual_url_03.Value = GetData(0, 4, "LINK_URL");
            ...
            hImgPath4.Value = GetData(0, 3, "FILE_PATH");
            hImgPath5.Value = GetData(0, 4, "FILE_PATH");
        ...
        private void SaveData(string inputType)
        {
            ...
            if ("VISUAL".Equals(inputType))
            {
                ...
                param.Append(CConst.DB_PARAM_DELIMITER).Append("1");
                ...
                param.Append("KOR");
                param.Append(CConst.DB_PARAM_DELIMITER).Append(inputType);
                param.Append(CConst.DB_PARAM_DELIMITER).Append("3");
                ...
                param.Append("KOR");
                param.Append(CConst.DB_PARAM_DELIMITER).Append(inputType);
                param.Append(CConst.DB_PARAM_DELIMITER).Append("4");
                ...
                param.Append("KOR");
                param.Append(CConst.DB_PARAM_DELIMITER).Append(inputType);
                param.Append(CConst.DB_PARAM_DELIMITER).Append("5");
