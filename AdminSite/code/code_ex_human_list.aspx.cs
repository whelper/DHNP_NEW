...
{
    /// <summary>
    /// 로직이 다 똑같아서 코드관련 페이지들은 한 페이지 개발해도 되나
    /// 페이지 별로 예외처리를 해야 되는 일이 발생할 수 있기 때문에 
    /// 분리해서 구현함.
    /// </summary>
    public partial class code_ex_human_list : PageBase
    {
        /// <summary>
        /// 고정 매뉴 번호
        /// </summary>
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./code_ex_human_list.aspx?LANG_CD=" + LANG_CD);
        }
