<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="code_device_list.aspx.cs" Inherits="AdminSite.code.code_device_list" %>
...
<div id="content">
	...
	<div class="wrap_box">
        <ul class="list_tab  clearfix target" >
			<li<%if ("KOR".Equals(LANG_CD)) { %> class="tab_on"<%} %>><a href="code_device_list.aspx?LANG_CD=KOR">국문</a></li>
			<li<%if ("ENG".Equals(LANG_CD)) { %> class="tab_on"<%} %>><a href="code_device_list.aspx?LANG_CD=ENG">영문</a></li>
		</ul>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table_new scrollTable">
                ...
                %>
					<tr>
						...
						<td><a href="./code_device_list.aspx?catgNo=<%=GetData(i, "CATG_NO")%>&crud=S&LANG_CD=<%=LANG_CD %>"><%=GetData(i, "CATG_NM")%></td>
...
<script language="javascript" type="text/javascript">
    ...
    function CheckDelValid(catgNo) {
        if (confirm('삭제하시겠습니까?')) {
            location.href = "./code_device_list.aspx?catgNo=" + catgNo + "&crud=D";
        }
    }		
</script>
