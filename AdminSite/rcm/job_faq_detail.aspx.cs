...
{
    public partial class job_faq_detail : PageBase
    {
        ...
        private void SearchData()
        {
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                SetDataList(3533, param.ToString());
            }
        }
        ...
        private void SaveData()
        {
            ...
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                result = ExecuteQueryResult(3534, param.ToString());
            }
            else
            {
                // 입력 모드
                result = ExecuteQueryResult(3535, param.ToString());
            }
        ...
        private void RemoveData()
        {
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                string[] result = ExecuteQueryResult(3536, param.ToString());
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./job_faq_list.aspx");
        }
