...
{
    public partial class job_notify_detail : PageBase
    {
        ...
        private void SetControls()
        {
            ...
            if (GetDataCount() > 0)
            {
                ...
                string show_tp = GetData(0, "SHOW_TP");
                if (show_tp.Equals("2")) showTp2.Checked = true;
                else if (show_tp.Equals("3")) showTp3.Checked = true;
                else if (show_tp.Equals("4")) showTp4.Checked = true;
                else showTp1.Checked = true;
            } 
            else
            {
                showTp1.Checked = true;
            }
        }
        ...
        private void SaveData()
        {
            ...
            int show_type = 1;
            if (showTp2.Checked == true) show_type = 2;
            else if (showTp3.Checked == true) show_type = 3;
            else if (showTp4.Checked == true) show_type = 4;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./job_notify_list.aspx");
        }
