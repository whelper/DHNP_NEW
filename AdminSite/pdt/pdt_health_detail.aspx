<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="pdt_health_detail.aspx.cs" Inherits="AdminSite.pdt.pdt_health_detail" %>
...
<div id="content">
	...
	<div class="wrap_box">
        <ul class="list_tab  clearfix target" >
			<li<%if ("KOR".Equals(LANG_CD)) { %> class="tab_on"<%} %>><a href="pdt_health_detail.aspx?prod_cd=<%=ProdCd %>&LANG_CD=KOR">국문</a></li>
			<li<%if ("ENG".Equals(LANG_CD)) { %> class="tab_on"<%} %>><a href="pdt_health_detail.aspx?prod_cd=<%=ProdCd %>&LANG_CD=ENG">영문</a></li>
		</ul>
			<table cellpadding="0" cellspacing="0" border="0" class="table_frm">
				<colgroup>
					...
					<tr>
						...
						<td class="alignleft" colspan="2">     
                            <textarea  id="temper" runat="server" class="textarea_detail" rows="5"></textarea>
						</td>
					</tr>
					<tr>
