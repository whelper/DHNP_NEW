...
{
    public partial class pdt_health_detail : PageBase
    {
        //private const string LANG_CD = "KOR";
        private const string UPR_CATG_NO = "6";
        ...
        private void SaveData()
        {
            ...
            param.Append(CConst.DB_PARAM_DELIMITER).Append(""); // 카달로그 - 건강 기능 식품 입력 안함
            param.Append(CConst.DB_PARAM_DELIMITER).Append(menual);
            param.Append(CConst.DB_PARAM_DELIMITER).Append(""); // 썸네일 - 건강 기능 식품 입력 안함
            param.Append(CConst.DB_PARAM_DELIMITER).Append(prod_nm.Value);
            param.Append(CConst.DB_PARAM_DELIMITER).Append(""); // 효능 - 건강 기능 식품 입력 안함
            ...
            param.Append(CConst.DB_PARAM_DELIMITER).Append(""); //주의사항 - 건강 기능 식품 입력 안함
            param.Append(CConst.DB_PARAM_DELIMITER).Append(""); // 특장점 - 건강 기능 식품 입력 안함
            param.Append(CConst.DB_PARAM_DELIMITER).Append(""); // 개요 - 건강 기능 식품 입력 안함
            param.Append(CConst.DB_PARAM_DELIMITER).Append(""); // 보관 - 건강 기능 식품 입력 안함
            param.Append(CConst.DB_PARAM_DELIMITER).Append(""); // 규격 - 건강 기능 식품 입력 안함
            param.Append(CConst.DB_PARAM_DELIMITER).Append(""); // 비고 - 건강 기능 식품 입력 안함
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_health_list.aspx?prod_cd=" + ProdCd + "&LANG_CD=" + LANG_CD);
        }
        ...
        protected void btnDel_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_health_list.aspx");
        }
