...
{
    public partial class pdt_cha_info_detail : PageBase
    {
        ...
        private void SearchData()
        {
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                SetDataList(3223, param.ToString());
            }
        }
        ...
        private void SetControls()
        {
            ...
            if (GetDataCount() > 0)
            {
                ...
                mv_path_story.Value = GetData(0, "CLIP_URL");
                reg_date.Value = GetData(0, "REG_DATE");
        ...
        private void RemoveData()
        {
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                string[] result = ExecuteQueryResult(3226, param.ToString());
        ...
        private void DelFile(string col, string path)
        {
            ...
            DeleteFile(3227, param.ToString(), path);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_cha_info_list.aspx");
        }
