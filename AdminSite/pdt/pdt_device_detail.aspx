<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="pdt_device_detail.aspx.cs" Inherits="AdminSite.pdt.pdt_device_detail" %>
...
<div id="content">
	...
	<div class="wrap_box">
        <ul class="list_tab  clearfix target" >
			<li<%if ("KOR".Equals(LANG_CD)) { %> class="tab_on"<%} %>><a href="pdt_device_detail.aspx?prod_cd=<%=ProdCd %>&LANG_CD=KOR">국문</a></li>
			<li<%if ("ENG".Equals(LANG_CD)) { %> class="tab_on"<%} %>><a href="pdt_device_detail.aspx?prod_cd=<%=ProdCd %>&LANG_CD=ENG">영문</a></li>
		</ul>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table_frm">
				<colgroup>
					...
					<tr>
                        ...
                        <textarea  id="ingredi" runat="server" class="textarea_detail" ></textarea>
					</td>
					</tr>
					<tr>
						<th scope="row"> <label for="pdt_seongsang"> 성상 </label> </th>
						<td class="alignleft" colspan="2">     
                            <textarea  id="temper" runat="server" class="textarea_detail" ></textarea>
						</td>
					</tr>
					<tr>
						<th scope="row"> <label for="pdt_code"> 보험코드  </label> </th>
						<td class="alignleft" colspan="2">     
						 	<input type="text" id="insu_cd" runat="server" value="" class="span6 text" />      
						</td>
					</tr>
					<tr>
						<th scope="row">  <label for="pdt_money"> 약가  </label> </th>
						<td class="alignleft" colspan="2">     
						 	<input type="text" id="pmedi" runat="server" value="" class="span6 text" />      
						</td>
					</tr>
					<tr>
						<th scope="row"> <label for="pdt_unit"> 포장단위   </label> </th>
						<td class="alignleft">  
							<input type="text" id="pack_mea" runat="server" value="" class="span6 text" />      
						</td>
					</tr>
					<tr>
