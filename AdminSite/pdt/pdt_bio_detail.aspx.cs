...
{
    public partial class pdt_bio_detail : PageBase
    {
        ...
        private void InitControls()
        {
			...
			if (GetDataTableCount(0) > 0)
            {
                ...
                pdt_summary.InnerText = GetData(0, 0, "SUMR");
                usage.Text = GetData(0, 0, "USAGE");
                pdt_keep.Value = GetData(0, 0, "KEEP");
                pdt_boheom.Value = GetData(0, 0, "STAND");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_bio_list.aspx?prod_cd=" + ProdCd + "&LANG_CD=" + LANG_CD);
        }
        ...
        protected void btnDel_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_bio_list.aspx");
        }
