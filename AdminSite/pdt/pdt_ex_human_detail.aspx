<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="pdt_ex_human_detail.aspx.cs" Inherits="AdminSite.pdt.pdt_ex_human_detail" %>
...
<div id="content">
	...
	<div class="wrap_box">
		<ul class="list_tab  clearfix target" >
			<li<%if ("KOR".Equals(LANG_CD)) { %> class="tab_on"<%} %>><a href="pdt_ex_human_detail.aspx?prod_cd=<%=ProdCd %>&LANG_CD=KOR">국문</a></li>
			<li<%if ("ENG".Equals(LANG_CD)) { %> class="tab_on"<%} %>><a href="pdt_ex_human_detail.aspx?prod_cd=<%=ProdCd %>&LANG_CD=ENG">영문</a></li>
		</ul>
		...
		<tbody>
			...
			<tr>
				...
				<td class="alignleft" colspan="2">     
					<input type="text" runat="server" id="prod_cd"  value="" class="span6 text" />
					<label for="pdt_new" style="margin-left:10px;"> 
			...
			<tr>
				<th scope="row"> 
					<label for="pdt_kuseong">구성</label>   
				</th>
				<td class="alignleft" colspan="2">     
