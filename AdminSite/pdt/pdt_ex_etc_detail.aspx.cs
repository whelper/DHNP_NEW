...
{
    public partial class pdt_ex_etc_detail : PageBase
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_ex_etc_list.aspx?prod_cd=" + ProdCd + "&LANG_CD=" + LANG_CD);
        }
        ...
        protected void btnDel_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_ex_etc_list.aspx");
        }
