...
{
    public partial class pdt_ex_ani_detail : PageBase
    {
        //private const string LANG_CD = "KOR";
        private const string UPR_CATG_NO = "5";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_ex_ani_list.aspx?prod_cd=" + ProdCd + "&LANG_CD=" + LANG_CD);
        }
        ...
        protected void btnDel_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_ex_ani_list.aspx");
        }
