<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="pdt_health_list.aspx.cs" Inherits="AdminSite.pdt.pdt_health_list" %>
...
<div id="content">
	...
	<div class="wrap_box">
        <ul class="list_tab  clearfix target" >
		    <li class="tab_on"><a href="pdt_health_list.aspx">건강기능식품</a></li>
            <li><a href="pdt_catalog_list.aspx?upr_catg_no=6">대표카탈로그</a></li>
	    </ul>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table_new">
            ...
            %>
				<tr>
                    ...
                    <td class="alignleft" ><a href="pdt_health_detail.aspx?prod_cd=<%=GetData(i, "PROD_CD")%>"><%=GetData(i, "PROD_NM")%></a> </td>
		...
		<div class="btn_area clearfix">
			<div class="f_right">
				<a href="./pdt_health_detail.aspx"><span class="btn btn-ok">등록</span></a>
			</div>
		</div>
