...
{
    public partial class pdt_ex_human_detail : PageBase
    {
        //private const string LANG_CD = "KOR";
        private const string UPR_CATG_NO = "4";
        ...
        private void InitControls()
        {
			...
			if (GetDataTableCount(0) > 0)
            {
                ...
                catg_no.Value = GetData(0, 0, "CATG_NO");
                prod_info.InnerText = GetData(0, 0, "PROD_INFO");
        ...
        private void SaveData()
        {
            ...
            param.Append(CConst.DB_PARAM_DELIMITER).Append(compt.Value); // 구성
            param.Append(CConst.DB_PARAM_DELIMITER).Append(prod_info.Value); // 정보
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_ex_human_list.aspx?prod_cd=" + ProdCd + "&LANG_CD=" + LANG_CD);
        }
        ...
        protected void btnDel_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./pdt_ex_human_list.aspx");
        }
