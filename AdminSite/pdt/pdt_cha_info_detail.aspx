<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="pdt_cha_info_detail.aspx.cs" Inherits="AdminSite.pdt.pdt_cha_info_detail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceSubLayer" runat="server">
			    ...
			    <colgroup>
				    ...
				    <tbody>
                        ...
                        <tr>
						    ...
						    <td class="alignleft" colspan="2">
						 	    <input type="text" id="reg_date" class="span6 text" runat="server" placeholder="2014-01-02"> ex) 2014-01-02
						    </td>
					    </tr>
					    <tr>
						    <th scope="row"> 
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CheckValid() {
            ...
            textfd.chk('<%= writerNm.ClientID %>', "작성자명을 입력하세요!");
