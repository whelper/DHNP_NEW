...
{
    public partial class pdt_ex_human_list : PageBase
    {
        ...
        private void SearchData()
        {
            ...
            prodType = prod_body_drug.Checked ? prod_body_drug.Value : prodType;
            prodType = prod_ani_drug.Checked ? prod_ani_drug.Value : prodType;
