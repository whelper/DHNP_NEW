<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="new_list.aspx.cs" Inherits="AdminSite.pr.new_list" %>
...
<div id="content">
	...
	<div class="wrap_box">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table_new">
			...
			<tbody>
				...
				<tr>
					...
					<td class="alignleft" ><% if (GetData(i, "NEW_YN") == "Y") {%><i class="new"> NEW </i><%} %><a href="new_detail.aspx?seq_no=<%=GetData(i, "SEQ_NO")%>"><%=GetData(i, "TTL", 100)%></a></td>
		...
		<div class="btn_area clearfix">
			<div class="f_right">
				<a href="./new_head.aspx"><span class="btn btn-ok">머릿말 등록</span></a>
				<a href="./new_detail.aspx"><span class="btn btn-ok">등록</span></a>
			</div>
		</div>
