...
{
    public partial class new_detail : PageBase
    {
        ...
        private void SearchData()
        {
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                SetDataList(3303, param.ToString());
            }
        }
        ...
        private void SaveData()
        {
            ...
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                result = ExecuteQueryResult(3305, param.ToString());
            }
            else
            {
                // 입력 모드
                result = ExecuteQueryResult(3304, param.ToString());
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("./new_list.aspx?seq_no=" + Seq);
        }
