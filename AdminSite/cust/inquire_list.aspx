<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="inquire_list.aspx.cs" Inherits="AdminSite.cust.inquire_list" %>
	...
	<div class="wrap_box">
			...
			<tbody>
				<tr> 
					...
					<td class=" aligncenter">
						<asp:LinkButton ID="btn_inquire_list_Search" runat="server" onClick="btnSearch_Click">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="table_new">
			...
			<tr>
				...
				<td class="alignleft" ><% if (GetData(i, "NEW_YN") == "Y") {%><i class="new"> NEW </i><%} %><a href="inquire_detail.aspx?seq_no=<%=GetData(i, "SEQ_NO")%>"><%=GetData(i, "TTL")%></a></td>
		...
		<div class="btn_area clearfix">
			<div class="f_right">
				<a href="inquire_detail.aspx"><span class="btn btn-ok">등록</span></a>
			</div>
		</div>		
        -->				
