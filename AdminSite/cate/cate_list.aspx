	...
	<div class="wrap_box">
		...
		<div id="cate_0" class="">
			<table cellpadding="0" cellspacing="0" border="0" class="table_new scrollTable">
                ...
                %>
				<tr>
					<td class="cate ca-ml<%=s %>"><a href="?cate_no=<%=GetData(i, "CATE_NO")%>"><%=GetData(i, "CATE_CD")%></a></td>
					<td class="cate ca-ml<%=s %>"><a href="?cate_no=<%=GetData(i, "CATE_NO")%>"><%=GetData(i, "CATE_NAME")%></a></td>
					<td>
						<a href="?cate_no=<%=GetData(i, "CATE_NO")%>&dbjob=r"><span class="btn-small btn-primary">추가</span></a>
