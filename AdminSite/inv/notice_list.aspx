<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="notice_list.aspx.cs" Inherits="AdminSite.inv.notice_list" %>
...
<div id="content">
	...
	<div class="wrap_box">
		<table class="table_search">
			...
			<tbody>
				<tr> 
					...
					<td><!--   <input  type="text" id="pdt_name" class="span4 text" placeholder="제목을  입력해 주세요 ">  -->
						<select  id="s_search_type" style="width:90px;" runat="server">
							<option value="title">제목</option>
							<option value="title_cont">제목+내용 </option>
						</select>
						<input class="span4 text" type="text" id="txt_search_value" runat="server"/>
					</td> 
					...
					<td class=" aligncenter">
						<asp:LinkButton ID="btn_notice_Search" runat="server" onClick="btnSearch_Click">
			...
			<tr>
                ...
                <td class="alignleft" >
                    <% if (GetData(i, "NEW_YN") == "Y") {%>
                        <i class="new"> NEW </i>
                    <%} %>
                        <a href="notice_detail.aspx?seq_no=<%=GetData(i, "SEQ_NO")
                    %>"><%=GetData(i, "TTL", 100)%>
                        </a>
                </td>
		...
		<div class="btn_area clearfix">
			<div class="f_right">
				<a href="notice_head.aspx"><span class="btn btn-ok">머릿말 등록</span></a>
				<a href="notice_detail.aspx"><span class="btn btn-ok">등록</span></a>
			</div>
		</div>		
