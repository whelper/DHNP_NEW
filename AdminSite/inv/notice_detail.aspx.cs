    ...
    public partial class notice_detail : PageBase
    {
        ...
        private void SearchData()
        {
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                SetDataList(3475, param.ToString());
            }
        }
        ...
        private void SaveData()
        {
            ...
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                result = ExecuteQueryResult(3477, param.ToString());
            }
            else
            {
                // 입력 모드
                result = ExecuteQueryResult(3476, param.ToString());
            }
        ...
        private void RemoveData()
        {
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                string[] result = ExecuteQueryResult(3478, param.ToString());
