<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="ju_juju_list_eng.aspx.cs" Inherits="AdminSite.inv.ju_juju_list_eng" %>
	...
	<div class="wrap_box">
        ...
        * 영문 덮어쓰기는 국문탭에만 있는 기능으로 국문에 입력한 내용을 영문에 그대로 적용 시킵니다.
		<ul class="list_tab  clearfix target">
			<li ><a href="ju_juju_list.aspx"> 국문 </a></li>
			<li class="tab_on"><a href="ju_juju_list_eng.aspx"> 영문 </a></li>
		</ul>
