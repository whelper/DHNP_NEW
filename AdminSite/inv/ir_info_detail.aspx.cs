...
{
    public partial class ir_info_detail : PageBase
    {
        ...
        private void SearchData()
        {
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                SetDataList(3413, param.ToString());
            }
        }
        ...
        private void SaveData()
        {
            ...
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                result = ExecuteQueryResult(3415, param.ToString());
            }
            else
            {
                param.Append(CConst.DB_PARAM_DELIMITER).Append(Lang_cd);
                // 입력 모드
                result = ExecuteQueryResult(3414, param.ToString());
            }
        ...
        private void RemoveData()
        {
            if (CStringUtil.IsNullOrEmpty(Seq) == false)
            {
                ...
                string[] result = ExecuteQueryResult(3416, param.ToString());
        ...
        private void RedirectFromLangCd()
        {   
            if (Lang_cd.Equals("KOR"))
            {
                Response.Redirect("./ir_info_list.aspx");
            }
            else
            {
                Response.Redirect("./ir_info_list_eng.aspx");
            }
         }
