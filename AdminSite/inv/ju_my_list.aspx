<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="ju_my_list.aspx.cs" Inherits="AdminSite.inv.ju_my_list" %>
	...
	<div class="wrap_box">
        ...
        * 합계 라인 표기 : 국문 = "합계", 영문 = "Total"
		<ul class="list_tab  clearfix target">
			<li class="tab_on"><a href="ju_my_list.aspx"> 국문 </a></li>
			<li ><a href="ju_my_list_eng.aspx"> 영문 </a></li>
		</ul>
