...
{
    public partial class money_mark_list : PageBase
    {
        ...
        private void SaveData()
        {
            ...
            for (int k = 0; k < loop; k++)
            {
                ...
                ExecuteQueryInvFinDtl(1, subject1, subject2, subject3, LANG_CD[k]);
                ExecuteQueryInvFinDtl(2, subject1_1, subject2_1, subject3_1, LANG_CD[k]);
                ...
                ExecuteQueryInvFinDtl(3, ca_data1, ca_data2, ca_data3, LANG_CD[k]);

                String ca_data4 = Request["ca_data4"];
                String ca_data5 = Request["ca_data5"];
                String ca_data6 = Request["ca_data6"];

                ExecuteQueryInvFinDtl(4, ca_data4, ca_data5, ca_data6, LANG_CD[k]);
                ...
                ExecuteQueryInvFinDtl(5, nca_data1, nca_data2, nca_data3, LANG_CD[k]);

                String nca_data4 = Request["nca_data4"];
                String nca_data5 = Request["nca_data5"];
                String nca_data6 = Request["nca_data6"];

                ExecuteQueryInvFinDtl(6, nca_data4, nca_data5, nca_data6, LANG_CD[k]);
                ...
                ExecuteQueryInvFinDtl(7, ca_t_data1, ca_t_data2, ca_t_data3, LANG_CD[k]);
                ...
                ExecuteQueryInvFinDtl(8, cd_data1, cd_data2, cd_data3, LANG_CD[k]);

                String cd_data4 = Request["cd_data4"];
                String cd_data5 = Request["cd_data5"];
                String cd_data6 = Request["cd_data6"];

                ExecuteQueryInvFinDtl(9, cd_data4, cd_data5, cd_data6, LANG_CD[k]);
                ...
                ExecuteQueryInvFinDtl(10, ncd_data1, ncd_data2, ncd_data3, LANG_CD[k]);

                String ncd_data4 = Request["ncd_data4"];
                String ncd_data5 = Request["ncd_data5"];
                String ncd_data6 = Request["ncd_data6"];

                ExecuteQueryInvFinDtl(11, ncd_data4, ncd_data5, ncd_data6, LANG_CD[k]);
                ...
                ExecuteQueryInvFinDtl(12, cd_t_data1, cd_t_data2, cd_t_data3, LANG_CD[k]);
                ...
                ExecuteQueryInvFinDtl(13, cp_data1, cp_data2, cp_data3, LANG_CD[k]);
                ExecuteQueryInvFinDtl(14, cp_data4, cp_data5, cp_data6, LANG_CD[k]);
                ...
                ExecuteQueryInvFinDtl(15, cad_t_data1, cad_t_data2, cad_t_data3, LANG_CD[k]);
                ...
                if (ca_ttls != null && ca_ttls.Length > 0)
                {
                    for (int i = 0; i < ca_ttls.Length; i++)
                    {
                        ...
                        ExecuteQueryInvFinDtlData("CA", param1, param2, param3, param4, LANG_CD[k]);
                    }
                }
                ...
                if (nca_ttls != null && nca_ttls.Length > 0)
                {
                    for (int i = 0; i < nca_ttls.Length; i++)
                    {
                        ...
                        ExecuteQueryInvFinDtlData("NCA", param1, param2, param3, param4, LANG_CD[k]);
                    }
                }
                ...
                if (cd_ttls != null && cd_ttls.Length > 0)
                {
                    for (int i = 0; i < cd_ttls.Length; i++)
                    {
                        ...
                        ExecuteQueryInvFinDtlData("CD", param1, param2, param3, param4, LANG_CD[k]);
                    }
                }
                ...
                if (ncd_ttls != null && ncd_ttls.Length > 0)
                {
                    for (int i = 0; i < ncd_ttls.Length; i++)
                    {
                        ...
                        ExecuteQueryInvFinDtlData("NCD", param1, param2, param3, param4, LANG_CD[k]);
                    }
                }
                ...
                if (cp_ttls != null && cp_ttls.Length > 0)
                {
                    for (int i = 0; i < cp_ttls.Length; i++)
                    {
                        ...
                        ExecuteQueryInvFinDtlData("CP", param1, param2, param3, param4, LANG_CD[k]);
                    }
                }
            }
        ...
        private void ExecuteQueryInvFinDtl(int seq, string data1, string data2, string data3, string LANG_CD)
        {
            StringBuilder param = new StringBuilder();
            param.Append(seq);
        ...
        private void ExecuteQueryInvFinDtlData(string subject, string atc_nm, string data1, string data2, string data3, string LANG_CD)
        {
            StringBuilder param = new StringBuilder();
