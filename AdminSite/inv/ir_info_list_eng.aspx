<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="ir_info_list_eng.aspx.cs" Inherits="AdminSite.inv.ir_info_list_eng" %>
...
<div id="content">
	...
	<div class="wrap_box">
		<ul class="list_tab  clearfix target">
			<li ><a href="ir_info_list.aspx"> 국문 </a></li>
			<li class="tab_on"><a href="ir_info_list_eng.aspx"> 영문 </a></li>
		</ul>
			...
			<tbody>
				<tr> 
					...
					<td>  <!-- <input type="text" class="span4 text" placeholder="등록일을   입력해 주세요 "> -->
					    ...
					    <input type="hidden" name="start_date"  id="end_date" runat="server"/> 
					</td> 
					<td class=" aligncenter">
						<asp:LinkButton ID="btn_ir_info_eng_Search" runat="server" onClick="btnSearch_Click">
			...
			<tr>
                ...
                <td class="alignleft" >
                    <% if (GetData(i, "NEW_YN") == "Y") {%>
                        <i class="new"> NEW </i>
                    <%} %>
                        <a href="ir_info_detail.aspx?seq_no=<%=GetData(i, "SEQ_NO")
                    %>"><%=GetData(i, "TTL", 100)%>
                        </a>
                </td>
		...
		<div class="btn_area clearfix">
			<div class="f_right">
				<a href="ir_info_detail.aspx?lang_cd=ENG"><span class="btn btn-ok">등록</span></a>
			</div>
		</div>	
