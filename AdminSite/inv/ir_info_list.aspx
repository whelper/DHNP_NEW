<%@ Page Language="C#" MasterPageFile="~/SiteSub.Master" AutoEventWireup="true" CodeBehind="ir_info_list.aspx.cs" Inherits="AdminSite.inv.ir_info_list" %>
...
<div id="content">
	...
	<div class="wrap_box">
		<ul class="list_tab  clearfix target">
			<li class="tab_on"><a href="ir_info_list.aspx"> 국문 </a></li>
			<li><a href="ir_info_list_eng.aspx"> 영문 </a></li>
		</ul>
			...
			<tbody>
				<tr> 
					...
					<td class=" aligncenter">
						<asp:LinkButton ID="btn_ir_info_Search" runat="server" onClick="btnSearch_Click">
		...
		<div class="btn_area clearfix">
			<div class="f_right">
				<a href="ir_info_detail.aspx?lang_cd=KOR"><span class="btn btn-ok">등록</span></a>
			</div>
		</div>	
