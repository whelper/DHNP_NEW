        ...
        public DataSet SelectSql(int index, string arg)
        {
            ...
            switch (index)
            {
                ...
                case 3204:// 제품관리 입력
					...
					sqldbtype[39] = SqlDbType.VarChar;
					sqldbtype[40] = SqlDbType.VarChar;

					// 마지막 인자값 항상 확인(파라미터 총수 임)
					ds = command.ExecuteDataSetSecure("USP_ADMIN_3204_PROD_DETAIL_I", variable, m_value, sqldbtype, 41);
                    break;
                ...
                case 3205:// 제품관리 수정
					...
					// 마지막 인자값 항상 확인(파라미터 총수 임)
					ds = command.ExecuteDataSetSecure("USP_ADMIN_3205_PROD_DETAIL_U", variable, m_value, sqldbtype, 41);
                    break;
               ...
               case 3517: // 채용공고 삭제 
                ...
                case 2300:// 제품문의 등록
					...
					// 마지막 인자값 항상 확인(파라미터 총수 임)
					ds = command.ExecuteDataSetSecure("USP_MOBILE_2300_CUST_PROD_INQ_I", variable, m_value, sqldbtype, 6);
                    break;
